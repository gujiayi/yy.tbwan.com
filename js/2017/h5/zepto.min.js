...
var C9377 = {
	https: https,
	url: https ? 'https://h5.9377.com' : 'http://h5.9377.com',
	app_url: https ? 'https://wvw.9377.com/h5' : 'http://wvw.9377.com/h5',
...
$(function($) {
	...
	if ($_COOKIE['admin_url']) {
		function _data_url(_this, action) {
			...
			var url = $_COOKIE['admin_url'] + '/data.php?act=add&id='+ id +'&ext=' + encodeURIComponent(param);
			return url;
		}
		try{
